                    ...
                    <div class="item-card" <?=$item['mark']?'style="border-bottom: 3px solid #117a8b;"':'';?>>
                        ...
                        <div class="item-info">
                            <ul>
                                ...
                                <li><a onclick="action('/admin/api/action',<?=$item['id'];?>,'trash','article','创作恢复成功','创作恢复失败')"><i class="czs-prototype"> </i> 恢复</a></li>
                                <li><a onclick="action('/admin/api/action',<?=$item['id'];?>,'destory','article','创作删除成功','创作删除失败')" title="一旦删除无法恢复"><i class="czs-trash-l"></i> 删除</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
