...
<div class="nobita-post-list">
    <div class="n-post-list">
        ...
        <div class="n-user-nav">
            <ul>
                <li><a href="/profile/dynamic" class="<?= $dynamicActive; ?>">动态</a></li>
                <li><a href="/profile/article" class="<?= $activeArticle; ?>">个人文章</a></li>
                <li><a href="/profile/comment" class="<?= $activeComment; ?>">评论</a></li>
<!--                <li><a href="">消息</a></li>-->
                <?=$userData['base']['group']==1?'<li><a href="/profile/write" target="_blank">写文章</a></li>':''?>
