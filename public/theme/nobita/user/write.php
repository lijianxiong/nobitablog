    ...
    <div class="n-user-article-edit">
        <form action="/admin/article/update" method="post">
            ...
            <div class="form-group a-header">
                <div class="a-title"><input class="form-control title-input col-lg-11" name="title" id="title" type="text" value="<?=$data['title']?>" placeholder="##请在此输入创作标题##"></div>
                <div class="a-more">
...
<script>
    function showTipsAlert(value) {
        ...
        $('.n-user-msg').show(500);
        setTimeout(function(){$('.n-user-msg').hide(500)},10000);
    }
